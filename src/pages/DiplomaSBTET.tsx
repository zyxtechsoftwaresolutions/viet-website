...
const DiplomaSBTET: React.FC = () => {
  ...
  const sections = useMemo(() => [
    ...
    { id: 'time-table', title: 'Time Tables', icon: Clock },
  ...
  const noticeBoardItems = [
    {
      id: 1,
      title: '1-1 Sem results 2024 (Autonomous)',
      date: '2024',
      type: 'results',
      link: '#',
      isNew: true
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              DIPLOMA (SBTET) Examination Cell
            </h1>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            <tr className="hover:bg-gray-50">
                              <td className="border border-gray-300 px-4 py-2">Syllabus</td>
                              <td className="border border-gray-300 px-4 py-2">
                                <Button variant="outline" size="sm" className="flex items-center gap-1">
                                  <Download className="w-4 h-4" />
                                  Download
                ...
                >
                  <Card className="shadow-lg mb-6">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-600">Time tables will be available here.</p>
                    </CardContent>
                  </Card>
                </motion.div>
              )}
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            <tr className="hover:bg-gray-50">
                              <td className="border border-gray-300 px-4 py-2">Circulars</td>
                              <td className="border border-gray-300 px-4 py-2">
                                <Button variant="outline" size="sm" className="flex items-center gap-1">
                                  <Download className="w-4 h-4" />
                                  Download
                  ...
                  <Card className="shadow-lg mb-6">
                    <CardContent className="p-6">
                      ...
                      <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
                        <h3 className="font-semibold text-lg mb-4">Click here for results</h3>
                          ...
                          <CardContent className="p-6">
                            <div className="flex items-center gap-3 mb-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">MR. P. PRASAD</p>
                              </div>
                            </div>
                          </CardContent>
                        </Card>
                        ...
                        <Card className="bg-gradient-to-br from-green-50 to-green-100">
                          <CardContent className="p-6">
                            <div className="flex items-center gap-3 mb-4">
                              ...
                              <div>
                                <h3 className="font-bold text-lg">Controller of Examination (DIPLOMA)</h3>
                        ...
                        <Card className="bg-gradient-to-br from-purple-50 to-purple-100">
                          <CardContent className="p-6">
                            <div className="flex items-center gap-3 mb-4">
                              ...
                              <div>
                                <h3 className="font-bold text-lg">Additional Controller of Examinations (DIPLOMA)</h3>
                        ...
                        <Card className="bg-gradient-to-br from-orange-50 to-orange-100">
                          <CardContent className="p-6">
                            <div className="flex items-center gap-3 mb-4">
                              ...
                              <div>
                                <h3 className="font-bold text-lg">Additional Controller of Examinations-2 (DIPLOMA)</h3>
