                            ...
                            >
                              <a
                                ...
                                onClick={(e) => {
                                  ...
                                  } else if (menuItem.name === 'About US' || menuItem.name === 'Vision & Mission' || menuItem.name === 'Chairman' || menuItem.name === 'HR' || menuItem.name === 'Principal' || menuItem.name === 'Diploma Principal' || menuItem.name === 'Faculty') {
