...
<p>VIET is affiliated to Jawaharlal Nehru Technological University – Gurajada Vizianagaram (JNTU-GV), Andhra Pradesh. The Institute follows the curriculum as prescribed by the Jawaharlal Nehru Technological University – Gurajada Vizianagaram (JNTU-GV). The academic calendar provided by the University is followed. The academic and other activities are planned for the semester and a calendar of events is prepared by the institute also. At the beginning of the semester the faculty members prepare the lesson plans for their respective subjects. As per the scheduled dates of academic calendar, internal/ end semester examinations for students are conducted in each semester. For the weaker category of students, remedial classes are conducted for different subjects and evaluation of outcome. For the laboratory classes, in addition to the lesson plans, lab manuals are prepared for each subject by the faculty and distributed to the students. Industrial visits are arranged to bridge the gap between theoretical knowledge and Industrial applications.</p>
...
<p><strong>Building skilled professionals for tomorrow!</strong></p>`,
        inspiration: {
          quote: 'The best way to predict the future is to create it with skill, dedication, and hard work.',
